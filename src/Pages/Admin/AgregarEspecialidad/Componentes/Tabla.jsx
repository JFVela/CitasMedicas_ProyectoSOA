...
const TablaEspecialidades = ({
  ...
  const especialidadesPaginadas = especialidades.slice(pagina * filasPerPagina, pagina * filasPerPagina + filasPerPagina)
          ...
          <TableBody>
            {especialidadesPaginadas.map((especialidad) => (
              <TableRow hover key={especialidad.id}>
                {cabeceras.map((cabecera) => (
                  <TableCell key={`${especialidad.id}-${cabecera.id}`} align="left">
                    {especialidad[cabecera.id]}
                  </TableCell>
                ))}
                <TableCell align="center">
                  <Tooltip title="Editar">
                    <IconButton onClick={() => onEditar(especialidad)}>
                      <EditIcon />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="Eliminar">
                    <IconButton onClick={() => confirmarEliminacion(especialidad)}>
                      <DeleteIcon />
                    </IconButton>
                  </Tooltip>
                </TableCell>
